function [] = PCA_Mahanobilis_allCh(par,datum)


data = [];
for i = 1:size(datum.inAgreement1,2)
    %holder = [holder; datum.inAgreement1{i}]
    data = cat(3,data,datum.inAgreement1{i});
end
...
[coeff,score,latent,tsquared,explained] = pca(data1);
