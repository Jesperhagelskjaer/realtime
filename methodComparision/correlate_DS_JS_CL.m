function [datum] = correlate_DS_JS_CL(par,datum,varargin)
...
if ~exist('datum.error','var')
    ...
    datum.tSpikes_MClust_cor  = datum.tSpikes_MClust(shufleVector_MS);
    datum.spikes_MClust_cor   = datum.spikes_MClust(shufleVector_MS);
