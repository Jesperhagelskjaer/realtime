...
noiseLevel=0.00; % 0.03 standard variation of noise - 0.0 disable adding noise
...
filter1.fc1=1600; %Frequency cut 1 (start of bandpass) 300Hz
filter1.fc2=5000; %Frequency cut 2 (end of bandpass) 6000Hz
filter1.fc3=6000; %Transition band between fc2 and fc3 
...
%     subplot(3,1,3);
%     surf(yk); %y,Y
%     title('Kilosort filtered template and noise');
